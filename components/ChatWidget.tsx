...
const renderMessage = (text: string) => {
  if (text) {
    ...
    // Convert WhatsApp terms to Email terms dynamically
    text = text.replace(/WhatsApp'tan/gi, 'e-posta üzerinden');
    text = text.replace(/WhatsApp'a/gi, 'e-postaya');
    text = text.replace(/WhatsApp/gi, 'E-posta');
  }
