      ...
      <div className="pt-40 pb-24 relative z-10">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <div className="glass rounded-3xl p-8 md:p-12 border border-white/10 text-white/80 text-lg leading-relaxed space-y-6">
            <p>Türkiye'de 85 milyonun üzerinde WhatsApp kullanıcısı var. Hastalarınız zaten orada. Peki kliniğiniz?</p>
            <p>WhatsApp randevu sistemi kurduğunuzda şunlar değişir: Hastalar istedikleri saatten randevu alır, sekreterinizin telefon yükü %80 azalır, randevu onayları otomatik gider, iptal ve değişiklikler anında sisteme yansır.</p>
            <p>Radent AI olarak kurduğumuz sistemlerde kliniklerin randevu doluluk oranı ortalama %40 artıyor.</p>
          </div>
