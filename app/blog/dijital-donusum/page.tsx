      ...
      <div className="pt-40 pb-24 relative z-10">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-tight mb-6">
            Diş Kliniklerinde Dijital Dönüşüm: Nereden Başlamalı?
          </h1>
          ...
          <div className="glass rounded-3xl p-8 md:p-12 border border-white/10 text-white/80 text-lg leading-relaxed space-y-6">
            <p>Dijital dönüşüm deyince aklınıza büyük yatırımlar, karmaşık sistemler geliyor olabilir. Ama aslında küçük bir adımla başlayabilirsiniz.</p>
            <p>En kolay başlangıç noktası: Randevu sisteminizi otomatikleştirmek. Çünkü klinik gelirinin %100'ü randevudan geliyor. Randevu sürecinizi iyileştirmek en hızlı ve en ölçülebilir sonucu verir.</p>
            <p>Sonraki adımlar: Hasta iletişimini otomatikleştirmek, analitik takip kurmak, online varlığınızı güçlendirmek.</p>
          </div>
