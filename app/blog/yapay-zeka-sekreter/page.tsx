      ...
      <div className="pt-40 pb-24 relative z-10">
        <div className="max-w-3xl mx-auto px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-black leading-tight tracking-tight mb-6">
            Yapay Zeka Sekreter mi, İnsan Sekreter mi?
          </h1>
          ...
          <div className="glass rounded-3xl p-8 md:p-12 border border-white/10 text-white/80 text-lg leading-relaxed space-y-6">
            <p>Bu sorunun cevabı ikisi de değil: ikisi birlikte.</p>
            <p>Yapay zeka sekreterin iyi olduğu şeyler: 7/24 çalışmak, randevu almak, hatırlatma göndermek, hiç yorulmamak, hata yapmamak.</p>
            <p>İnsan sekreterin iyi olduğu şeyler: Hasta ilişkisi kurmak, zor durumları yönetmek, empati göstermek.</p>
            <p>En akıllı klinikler yapay zekayı rutin işler için kullanıp sekreterini hasta deneyimine odaklıyor. Sonuç: Daha az maliyet, daha memnun hastalar.</p>
          </div>
